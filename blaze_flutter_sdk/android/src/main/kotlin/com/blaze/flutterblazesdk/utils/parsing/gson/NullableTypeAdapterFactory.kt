...
/*
 * This adapter verifies that non-optional fields are provided - otherwise this adapter throws a descriptive exception.
 * */
internal class NullableTypeAdapterFactory : TypeAdapterFactory {
        ...
        return object : TypeAdapter<T>() {
            ...
            override fun read(input: JsonReader): T? {
                try {
                        ...
                        kotlinClass.memberProperties.forEach {
                            if (!it.returnType.isMarkedNullable && it.get(value) == null) {
                                throw JsonParseException(
                                        "Value of non-nullable member [${it.name}] cannot be null"
                                )
                            }
                        }
                    }
                    ...
                    Log.d(err::class.java.simpleName, "Error parsing JSON: ${err.message}")
                    throw err
                }
            }
        }
